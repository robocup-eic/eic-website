...
const Achivement = () => {
  ...
  return (
    <section className="relative mx-auto px-24 sm:px-16 lg:px-20 py-16 min-h-[90vh]">
      <Typography type="h1" className="text-8xl font-medium font-display text-center" custom={true}>
        Achivement
      </Typography>
